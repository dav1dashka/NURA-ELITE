...
***************************************************************************** */
        ...
        function windowLoad() {
            ...
            function digitsCountersAnimate(digitsCounter) {
                ...
                const duration = parseInt(digitsCounter.dataset.digitsCounter) ? parseInt(digitsCounter.dataset.digitsCounter) : 2500;
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            window.addEventListener("scroll", (function miniHeader(e) {
                const header = document.querySelector(".header__container");
                const elementTop = header.getBoundingClientRect().top;
                const scrollTop = window.scrollY;
                const elementPosition = scrollTop - elementTop;
                console.log(elementPosition);
                if (elementPosition > 40) header.classList.add("active"); else header.classList.remove("active");
            }));
        }));
        ...
        if (animItems.length > 0) {
            ...
            function animOnScroll() {
                for (let index = 0; index < animItems.length; index++) {
                    ...
                    if (window.pageYOffset > animItemOffset - animItemPoint && window.pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("active"); else if (!animItem.classList.contains("unhidden")) animItem.classList.remove("active");
                }
            }
            function offset(el) {
